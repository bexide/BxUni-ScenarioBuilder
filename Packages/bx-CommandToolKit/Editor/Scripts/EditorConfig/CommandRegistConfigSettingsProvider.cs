...
namespace BX.CommandToolKit.EditorInternal
{
    ...
    {
        const string k_projectSettingPath = "BX/CommandToolKit/CommandRegistConfig";
        ...
        [CommandToolKitEditorMenuItem("Help/ProjectSettings/RegistSettings", 79999999)]
        static void OpenCommandToolKitRegistSettings()
        {
