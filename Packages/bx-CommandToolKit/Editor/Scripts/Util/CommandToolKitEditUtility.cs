...
{
    internal static class CommandToolKitEditUtility
    {
        #region const

        static readonly string k_saveDirectoryPathKey = $"CommandToolKit.{PlayerSettings.productGUID}.SaveKey";
        ...
        [CommandToolKitEditorMenuItem("File/New Scenario", 99999999)]
        ...
        [CommandToolKitEditorMenuItem("File/Open Scenario", 99999998)]
        ...
        [CommandToolKitEditorMenuItem("File/Export/Json", 99999989)]
        ...
        [CommandToolKitEditorMenuItem("File/Export/TSV", 99999988)]
