            ...
            if (reorderableListRect.Contains(mousePos) && ev.RightMouseDown())
            {
                ...
                if (selectedCommands.Any())
                {
                    menu.AddItems(
                        ...
                        {
                            CommandToolKitEditUtility.ClipBoardCommands = selectedCommands;
                ...
                if (CommandToolKitEditUtility.ClipBoardCommands.Any())
                {
                    menu.AddItems(
                        new SubMenuItem("Paset Command As New", CommandToolKitEditUtility.PasetAsNew)
                    );
                }
                menu.Show();
            }
