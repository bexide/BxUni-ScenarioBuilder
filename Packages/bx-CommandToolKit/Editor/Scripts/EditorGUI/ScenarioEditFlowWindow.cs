...
namespace BX.CommandToolKit.EditorInternal
{
    internal partial class ScenarioEditFlowWindow : EditorWindow
    {
        ...
        const string k_editorName = "bx-commandToolKit";
        ...
        [MenuItem("BeXide/CommandToolKit/Edit")]
        ...
        void OnGUI()
        {
            ...
            if(CurrentEditData == null)
            {
                ...
                {
                    CommandToolKitEditUtility.CreateAsset();
                }
                if (GUILayout.Button("開く", GUILayout.Width(200)))
                {
                    CommandToolKitEditUtility.OpenAsset();
                }
            }
            else
            {
